...
/**
 * These tests were created for development purposes.
 * They might not be up to date anymore with the real code.
 * SEE: @{@link com.crosslang.uimahtmltotext.service.UimaTextTransferService}
 *
 * Will be replaced by Integration Tests with API calls
 */
